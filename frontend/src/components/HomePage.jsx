...
export default function HomePage({ onOpenDashboard }) {
  ...
  return <div className="public-site">
    <header className="site-header">
      <a className="site-brand" href="#home"><span className="brand-seal"><ShieldCheck size={27} /></span><span><b>Ratnagiri District General Workers Union</b><small>रत्नागिरी जिल्हा जनरल कामगार युनियन (संलग्न सीटू)</small></span></a>
